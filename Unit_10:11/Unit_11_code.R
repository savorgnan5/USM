...
library(dplyr)
library(tidyverse)
NYTIMES_KEY = "ULAGIigdFMCFsmJgB5cxcwKmCjnISU6W" #Your Key Here … get from NTY API website
...
#Confusion Matrix
caret::confusionMatrix(table(allNYTSearchTest$Classified,allNYTSearchTest$NewsOrOther)) #Actual in Columns
